...
large external data base**. This is generated by the script `setup.sh`
in the project folder `data/mammary/` of the
https://gitlab.com/raim/genomeBrowser/ project (release
...
* `All_SAAP_patient_level_quant_df.txt.gz`: as above for
  `Supplemental_Data_4.SAAP_reporter_quant.xlsx`,
* `All_SAAP_protein_filter_df.txt.gz`: as above for
